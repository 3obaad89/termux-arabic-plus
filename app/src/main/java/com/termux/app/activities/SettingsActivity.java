...
import com.termux.R;
import com.termux.app.activities.WhatsNewActivity;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class RootPreferencesFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    configureWhatsNewPreference(context);
                ...
                aboutPreference.setOnPreferenceClickListener(preference -> {
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            // Developer Contributions section (Layer 1 UI feature)
                            aboutString.append("\n\n## Developer Contributions\n");
                            aboutString.append("\n**Name:** Mohammed-Almashahery");
                            aboutString.append("\n**Telegram:** @Kim0_07");
                            aboutString.append("\n\n**Features Implemented:**\n");
                            aboutString.append("\n- Full Arabic BiDi stabilization (UAX #9 compliant layout)");
                            aboutString.append("\n- Fixed Arabic shaping using HarfBuzz pipeline");
                            aboutString.append("\n- Stable mixed Arabic / English command rendering");
                            aboutString.append("\n- Prompt rendering protection (no symbol inversion)");
                            aboutString.append("\n- Cursor isolation layer (no flicker rendering)");
                            aboutString.append("\n- Cached layout system for performance and deterministic output");
                            aboutString.append("\n\n##\n");
        ...
        private void configureWhatsNewPreference(@NonNull Context context) {
            Preference whatsNewPreference = findPreference("whats_new");
            if (whatsNewPreference != null) {
                whatsNewPreference.setOnPreferenceClickListener(preference -> {
                    WhatsNewActivity.startWhatsNewActivity(context, false);
                    return true;
                });
            }
        }
